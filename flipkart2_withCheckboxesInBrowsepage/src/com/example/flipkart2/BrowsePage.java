...
public class BrowsePage extends SherlockActivity implements OnDismissCallback{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		browsePageList.add(new BrowsePageListDetails(R.drawable.clplv1));
		browsePageList.add(new BrowsePageListDetails(R.drawable.clplv2));
		browsePageList.add(new BrowsePageListDetails(R.drawable.clplv1));
		browsePageList.add(new BrowsePageListDetails(R.drawable.clplv2));
		browsePageList.add(new BrowsePageListDetails(R.drawable.clplv1));
		browsePageList.add(new BrowsePageListDetails(R.drawable.clplv2));
		...
		adapter=new BrowsePageListAdapter(this, R.layout.browsepage_lv2, browsePageList);
	...
	*/
	...
	public void onBackPressed(){
		...
		int temp=0;
		for(int i=0;i<100;i++){
			if(adapter.checkedArray[i]==1){
				adapter.checkedArray[i]=0;
				temp=1;
			}
