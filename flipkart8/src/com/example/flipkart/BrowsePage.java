...
public class BrowsePage extends SherlockActivity implements OnDismissCallback{
	...
	public void animate(View v){		
		/*ImageView temps=(ImageView)findViewById(R.id.filter_bar);
		TranslateAnimation animate = new TranslateAnimation(0,0,0,temps.getHeight());
		animate.setDuration(500);
		animate.setFillAfter(true);
		temps.startAnimation(animate);		
		temps.setVisibility(View.GONE);
		
		ImageView temps2=(ImageView)findViewById(R.id.filter_bar_compare);
		TranslateAnimation animate2 = new TranslateAnimation(0,0,temps2.getHeight(),0);
		animate2.setDuration(500);
		animate2.setFillAfter(true);
		temps2.startAnimation(animate2);		
		temps2.setVisibility(View.VISIBLE);
	*/	
	}
